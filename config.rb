...
redirect "resume.html", to: "http://morgante.net/resume.pdf"
redirect "calendar.html", to: "http://morgante.net/schedule"
redirect "user/files/vcard.vcf.html", to: "/files/vcard.vcf"
